...
import { Menu, Settings, Monitor, Users, Mail, Phone, Briefcase, Award, X, Snowflake, Sun, Palmtree, Trees, PartyPopper, Target, Search, Globe, Wrench, Smartphone, ChevronDown, ChevronRight, CheckCircle2, ExternalLink } from 'lucide-react';
...
const clientsData = [
  {
    id: "lale-market",
    name: "Lale Market - Ede",
    service: "Instagram automatisering + TikTok marketing",
    description: [
      "Lale Market is een supermarkt gevestigd aan de Parkweg 131 in Ede. Toen wij met de eigenaar in gesprek gingen, bleek al snel dat er twee belangrijke uitdagingen waren. Enerzijds was de online zichtbaarheid van de supermarkt beperkt, waardoor veel potentiële klanten niet op de hoogte waren van de aanbiedingen en acties. Anderzijds kostte het wekelijks plaatsen van nieuwe bonussen en kortingen veel tijd, waardoor deze niet altijd op tijd online verschenen.",
      "Tijdens een uitgebreid gesprek hebben we eerst samen de huidige situatie geanalyseerd en de grootste knelpunten in kaart gebracht. Op basis daarvan hebben we een strategie ontwikkeld die niet alleen tijd bespaart, maar ook zorgt voor een sterkere online aanwezigheid.",
      "De eerste stap was het automatiseren van het proces rondom de wekelijkse aanbiedingen en bonussen. We hebben een systeem opgezet waarmee acties efficiënter worden verwerkt en automatisch worden gepubliceerd op Instagram en Facebook. Hierdoor zijn klanten altijd op tijd op de hoogte van de nieuwste aanbiedingen en hoeft het team van Lale Market hier aanzienlijk minder handmatig werk aan te besteden.",
      "Daarnaast zijn we actief bezig met het verder uitbreiden van hun online bereik via TikTok. Hiervoor ontwikkelen we contentstrategieën die aansluiten bij de doelgroep van de supermarkt. We bedenken creatieve concepten, filmen op locatie en verzorgen de volledige montage en afwerking van de video's. Het doel is om niet alleen meer zichtbaarheid te creëren, maar ook een betrokken online community op te bouwen rondom Lale Market.",
      "De samenwerking met Lale Market is nog volop in ontwikkeling. Door een combinatie van automatisering, social media marketing en creatieve contentcreatie werken we stap voor stap aan een sterkere online positie en een grotere lokale bekendheid van de supermarkt in Ede."
    ],
    workDone: [
      "Automatisering van kortingen en bonussen",
      "Publicatie op Instagram en Facebook",
      "TikTok-contentstrategie",
      "Filmen op locatie",
      "Editen van video's",
      "Verbetering van online zichtbaarheid"
    ],
    results: "Een consistente groei in online zichtbaarheid en een sterkere, actieve community op social media.",
    link: "https://www.instagram.com/lalesupermarkt/",
    linkText: "Bekijk Instagram",
    imageUrl: "https://github.com/hmimmanuel-design/gym-assets/blob/main/Lale%20market.jpg?raw=true"
  },
  {
    id: "bling-style",
    name: "Bling Style",
    service: "Webshop design & adverteren",
    imageUrlTop: "https://github.com/hmimmanuel-design/gym-assets/blob/main/ChatGPT_Image_17_mrt_2026__15_49_07-removebg-preview_210x@2x.webp?raw=true",
    description: [
      <div key="1" className="mb-4">
        <h5 className="text-white font-bold mb-2">Over Bling Style</h5>
        <p>Bling Style is een merk dat zich specialiseert in hoogwaardige custom kleding, afgewerkt met exclusieve rhinestones die speciaal uit Amerika worden geïmporteerd. Deze premium materialen zorgen voor een unieke uitstraling en een kwaliteit die zich onderscheidt van standaard bedrukkingen en decoraties.</p>
      </div>,
      <div key="2" className="mb-4">
        <h5 className="text-white font-bold mb-2">De uitdaging</h5>
        <p>Toen wij met de eigenaren van Bling Style om tafel gingen, werd al snel duidelijk dat hun grootste uitdaging niet bij het product lag, maar bij de online presentatie ervan. De kwaliteit van hun kleding en afwerking was hoog, maar de bestaande webshop sloot hier niet op aan. De oude website was verouderd, onoverzichtelijk en bood niet de gebruiksvriendelijke ervaring die klanten tegenwoordig verwachten. Hierdoor kwam de uitstraling van het merk onvoldoende tot zijn recht en werd het aankoopproces onnodig ingewikkeld.</p>
        <p className="mt-2">Tijdens onze gesprekken hebben we eerst uitgebreid gekeken naar de wensen, doelen en toekomstplannen van Bling Style. Samen hebben we vastgesteld welke onderdelen van de huidige webshop verbeterd moesten worden en hoe we de online ervaring beter konden laten aansluiten bij de kwaliteit van hun producten.</p>
      </div>,
      <div key="3" className="mb-4">
        <h5 className="text-white font-bold mb-2">Onze aanpak</h5>
        <p>Op basis daarvan zijn we begonnen met het ontwikkelen van een nieuwe webshop die modern, overzichtelijk en toegankelijk is voor iedere bezoeker. De focus ligt op een professionele uitstraling, eenvoudige navigatie en een soepele winkelervaring, zodat klanten gemakkelijk door het assortiment kunnen bladeren en hun bestelling kunnen plaatsen. Daarnaast zorgen we ervoor dat het unieke verhaal achter de exclusieve rhinestones en de aandacht voor kwaliteit duidelijk naar voren komt op de website.</p>
        <p className="mt-2">Naast de ontwikkeling van de nieuwe webshop hebben we ook gesproken over de toekomstige groei van het merk. Een belangrijk onderdeel daarvan is online adverteren om een groter publiek te bereiken en meer verkoop te genereren. Deze plannen staan nog steeds op de agenda, maar hebben momenteel een lagere prioriteit omdat de eigenaren druk bezig zijn met de voorbereidingen van hun aankomende bruiloft.</p>
      </div>,
      <div key="4">
        <h5 className="text-white font-bold mb-2">De toekomst</h5>
        <p>De samenwerking met Bling Style bevindt zich momenteel in een rustige fase, maar de basis voor verdere groei wordt al gelegd. Met een nieuwe, professionele webshop als fundament kan het merk zich straks beter presenteren, meer klanten bereiken en zich verder ontwikkelen tot een sterk online kledingmerk met een unieke identiteit.</p>
      </div>
    ],
    workDone: ["UI/UX Webshop redesign", "Advertentiecampagnes", "Conversie-optimalisatie (CRO)"],
    results: "Verbeterde winkelervaring voor klanten met als direct gevolg een stijging in de conversieratio.",
    link: "https://blingstyle.nl/",
    linkText: "Blingstyle.nl"
  },
  {
    id: "bedrijfsmarkt",
    name: "Bedrijfsmarkt",
    service: "TikTok Marketing (Filmen + Editen + Presenteren)",
    imageUrlTop: "https://github.com/hmimmanuel-design/gym-assets/blob/main/bedrijfsmarkt.png?raw=true",
    description: [
      <div key="1" className="mb-4">
        <h5 className="text-white font-bold mb-2">Over Bedrijfsmarkt</h5>
        <p>Bedrijfsmarkt is een startend platform dat ondernemers en bedrijven met elkaar verbindt. Het concept is vergelijkbaar met een marktplaats voor bedrijven, waar zakelijke vraag en aanbod samenkomen op één plek.</p>
      </div>,
      <div key="2" className="mb-4">
        <h5 className="text-white font-bold mb-2">De uitdaging</h5>
        <p>Tijdens onze gesprekken werd duidelijk dat de grootste uitdaging lag bij het vergroten van de naamsbekendheid en online zichtbaarheid. Daarom hebben we samen een TikTok-strategie ontwikkeld om meer ondernemers te bereiken en het platform onder de aandacht te brengen.</p>
      </div>,
      <div key="3" className="mb-4">
        <h5 className="text-white font-bold mb-2">Onze aanpak</h5>
        <p>Voor Bedrijfsmarkt verzorgen wij een groot deel van de contentproductie. Dit bestaat uit het bedenken van contentideeën, het filmen van video's en het professioneel editen van de content. Daarnaast presenteer ik, Micha Hasselaar, een deel van de video's zelf om magnetic marketing een persoonlijk gezicht te geven.</p>
      </div>,
      <div key="4">
        <h5 className="text-white font-bold mb-2">Resultaat</h5>
        <p>Met consistente content en een duidelijke groeistrategie werkt Bedrijfsmarkt aan een sterke online aanwezigheid en verdere groei van het platform.</p>
      </div>
    ],
    workDone: ["Conceptontwikkeling en scripten", "Videografie en presentatie", "Korte video editing (TikTok/Reels)"],
    results: "Toegenomen organisch bereik op short-form video platformen en hogere merkbekendheid bij de doelgroep.",
    link: "https://www.tiktok.com/@bedrijfsmarkt.nl?lang=nl-NL",
    linkText: "Bekijk TikTok"
  },
  {
    id: "joelle-fotografie",
    name: "Joelle Fotografie",
    service: "Website ontwikkeling & onderhoud",
    imageUrlTop: "https://github.com/hmimmanuel-design/gym-assets/blob/main/Joelle%20fotografie.webp?raw=true",
    description: [
      <div key="1" className="mb-4">
        <h5 className="text-white font-bold mb-2">Over Joelle Fotografie</h5>
        <p>Joelle Fotografie is een professionele fotografiedienst die zich richt op het vastleggen van bijzondere momenten en het creëren van hoogwaardige beelden. Voor een fotograaf is een sterke online presentatie essentieel, omdat potentiële klanten vaak eerst het portfolio bekijken voordat zij contact opnemen.</p>
      </div>,
      <div key="2" className="mb-4">
        <h5 className="text-white font-bold mb-2">De uitdaging</h5>
        <p>Tijdens onze gesprekken werd duidelijk dat Joelle behoefte had aan een moderne, goed werkende website die haar werk op een professionele manier presenteert. Het was belangrijk dat bezoekers direct een duidelijk beeld krijgen van haar stijl, ervaring en kwaliteit zodra ze de website bezoeken.</p>
      </div>,
      <div key="3" className="mb-4">
        <h5 className="text-white font-bold mb-2">Onze oplossing</h5>
        <p>Daarom hebben we gewerkt aan een overzichtelijke en gebruiksvriendelijke website waarin haar portfolio centraal staat. Bezoekers kunnen eenvoudig door haar werk bladeren, inspiratie opdoen en snel contact opnemen voor een fotoshoot of aanvraag.</p>
        <p className="mt-2">Naast de ontwikkeling van de website zorgen we ervoor dat deze technisch goed blijft functioneren en onderhouden wordt. Hierdoor kan Joelle zich volledig richten op haar fotografie, terwijl haar online presentatie professioneel en actueel blijft.</p>
      </div>,
      <div key="4">
        <h5 className="text-white font-bold mb-2">Resultaat</h5>
        <p>Met een sterke website als basis kunnen potentiële klanten direct kennismaken met haar werk en de kwaliteit zien die Joelle Fotografie te bieden heeft.</p>
      </div>
    ],
    workDone: ["Maatwerk website ontwikkeling", "Portfolio integratie", "Maandelijks technisch beheer"],
    results: "Een snelle en professionele online etalage voor potentiele opdrachtgevers.",
    link: "https://joellefotografie.com/",
    linkText: "Bezoek Website"
  },
  {
    id: "sonja-thuiszorg",
    name: "Sonja's Zorghulp",
    service: "Website ontwikkeling & onderhoud",
    imageUrlTop: "https://github.com/hmimmanuel-design/gym-assets/blob/main/Sonjas%20zorghulp.png?raw=true",
    description: [
      <div key="1" className="mb-4">
        <h5 className="text-white font-bold mb-2">Over Sonja's Zorghulp</h5>
        <p>Sonja's Zorghulp biedt persoonlijke ondersteuning en zorg aan huis.</p>
      </div>,
      <div key="2" className="mb-4">
        <h5 className="text-white font-bold mb-2">De uitdaging</h5>
        <p>Tijdens onze gesprekken werd duidelijk dat er behoefte was aan een professionele website die vertrouwen uitstraalt en bezoekers eenvoudig informeert over de aangeboden diensten.</p>
      </div>,
      <div key="3" className="mb-4">
        <h5 className="text-white font-bold mb-2">Onze oplossing</h5>
        <p>Daarom werken we aan een moderne en gebruiksvriendelijke website waarin de zorgverlening centraal staat. Bezoekers kunnen straks snel informatie vinden en eenvoudig contact opnemen.</p>
      </div>,
      <div key="4">
        <h5 className="text-white font-bold mb-2">Huidige status</h5>
        <p>De website bevindt zich momenteel nog in ontwikkeling. Het doel is om Sonja's Zorghulp een professionele online uitstraling te geven die aansluit bij de kwaliteit en persoonlijke aandacht van de organisatie.</p>
      </div>
    ],
    workDone: ["Toegankelijk webdesign", "Lokale SEO optimalisatie", "Doorlopend technisch onderhoud"],
    results: "Betere lokale vindbaarheid en eenvoudigere communicatie voor cliënten en zorgbehoevenden.",
    link: "https://www.sonjaszorghulp.nl/",
    linkText: "Bezoek Website"
  },
  {
    id: "cadeauhuis-wageningen",
    name: "Cadeauhuis Wageningen",
    service: "Website onderhoud & optimalisatie",
    description: "Structureel technisch onderhoud en snelheidsverbeteringen voor een bestaande website om een soepele en veilige ervaring te garanderen.",
    workDone: ["Snelheidsoptimalisatie", "Update beheer en beveiliging", "Kleine UX verbeteringen"],
    results: "Aanzienlijke vermindering in laadtijd en verbeterde technische prestaties over de hele linie.",
    link: null,
...
const App: React.FC = () => {
  ...
  const [activeClientModal, setActiveClientModal] = useState<string | null>(null);
  ...
  useEffect(() => {
    ...
    setOnlineCount(getWeightedRandomCount());
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-slate-900 text-white select-none">
            ...
            <div className="bg-slate-800/40 p-6 rounded-lg border-l-4 border-blue-500 shadow-inner">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {clientsData.map(client => (
                  <div key={client.id} className="bg-slate-800/80 p-4 rounded border border-slate-700/50 flex flex-col gap-2 hover:border-blue-500/50 transition-colors">
                    <div className="flex flex-col gap-1 mb-2">
                      <span className="font-bold text-lg text-white">{client.name}</span>
                      <span className="text-sm text-blue-400 leading-tight">{client.service}</span>
                    </div>
                    <button 
                      onClick={() => setActiveClientModal(client.id)}
                      className="mt-auto px-4 py-2 bg-blue-600/20 hover:bg-blue-600/40 text-blue-300 text-xs font-bold uppercase rounded border border-blue-500/30 transition-colors flex items-center justify-between group"
                    >
      ...
      {/* CASE STUDY MODAL FOR CLIENTS */}
      {activeClientModal && (
        <Modal 
          isOpen={true} 
          onClose={() => setActiveClientModal(null)}
          title={activeClientModal === "cadeauhuis-wageningen" ? " " : (clientsData.find(c => c.id === activeClientModal)?.name || "Project")}
        >
          {clientsData.filter(c => c.id === activeClientModal).map(client => {
            if (client.id === "cadeauhuis-wageningen") {
              return (
                <div key={client.id} className="flex flex-col items-center justify-center min-h-[50vh] text-center animate-in fade-in duration-300">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 uppercase tracking-wider">
                    {client.name}
                  </h2>
                  <p className="text-xl sm:text-2xl text-blue-400 font-bold tracking-widest uppercase">
                    Coming Soon
                  </p>
                </div>
              );
            ...
            return (
            <div key={client.id} className="flex flex-col gap-6 animate-in fade-in duration-300">
              <div className="bg-slate-800/80 p-6 rounded-lg border-l-4 border-blue-500 shadow-inner">
                 ...
                 {/* TOP IMAGE FOR MODALS */}
                 {(client as any).imageUrlTop && (
                   <div className="mb-6 bg-slate-900/50 rounded-lg p-4 border border-slate-700/50 flex justify-center items-center">
                     <img 
                       src={(client as any).imageUrlTop} 
                       alt={`${client.name} impressie`} 
                 ...
                 <div className="space-y-6">
                   <div>
                     <h4 className="text-sm uppercase tracking-wider font-bold text-slate-400 mb-2">Het Project</h4>
                   ...
                   <div>
                     <h4 className="text-sm uppercase tracking-wider font-bold text-slate-400 mb-2">Uitgevoerde Werkzaamheden</h4>
                     <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-slate-300">
                       {client.workDone.map((work, idx) => (
                         <li key={idx} className="flex items-start gap-2 bg-slate-700/30 p-3 rounded">
                   ...
                   <div>
                     <h4 className="text-sm uppercase tracking-wider font-bold text-slate-400 mb-2">Resultaten</h4>
                     <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded text-emerald-200">
                        {client.results}
                     </div>
                   </div>
                   ...
                   {client.imageUrl && (
                     <div className="mt-6">
                       <img 
                         src={client.imageUrl} 
                         alt={`${client.name} impressie`} 
                         className="w-full h-auto rounded-lg shadow-lg border border-slate-700/50 object-cover" 
                       />
                     </div>
                   )}
                 </div>
              ...
              {client.link ? (
                 <a 
                   ...
                   className="w-full bg-slate-700 hover:bg-slate-600 text-white font-bold py-4 rounded transition-colors flex items-center justify-center gap-2 shadow-lg"
                 >
                   <ExternalLink size={20} />
                   {client.linkText}
                 </a>
              ) : (
                 <div className="w-full bg-slate-800 border border-slate-700 text-slate-400 font-bold py-4 rounded flex items-center justify-center gap-2 shadow-inner cursor-not-allowed">
                   {client.linkText}
                 </div>
              )}
              ...
              <button 
                ...
                className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-4 rounded transition-colors flex items-center justify-center gap-2 shadow-lg"
              >
                Klaar voor resultaat? Neem contact op!
              </button>
            </div>
            );
          })}
