...
export const LobbyCharacter: React.FC<LobbyCharacterProps> = ({ config, isLeader, isOpen, onToggle }) => {
        ...
        */}
        ...
        <div className="absolute -top-24 w-full flex flex-col items-center pointer-events-none">
          ...
          <div className="relative w-full h-40 flex justify-center items-end pb-4">
              ...
              <div className="absolute bottom-4 flex flex-col items-center transition-all duration-300 pointer-events-none opacity-100 md:group-hover:opacity-0 md:group-hover:translate-y-4">
                  {/* Level Badge */}
              ...
              {config.speechText && (
                  <div className="hidden md:block absolute bottom-0 w-[140%] bg-white text-slate-900 p-4 rounded-xl border-4 border-blue-500 shadow-[0_0_20px_rgba(59,130,246,0.5)] transition-all duration-300 z-50 pointer-events-auto opacity-0 scale-90 translate-y-4 md:group-hover:opacity-100 md:group-hover:scale-100 md:group-hover:translate-y-0">
                      <p className="text-sm font-semibold leading-relaxed relative z-10 text-center">
                          {config.speechText}
                      </p>
                      {/* Bubble Tail */}
      ...
      {isOpen && config.speechText && (
        ...
        >
          ...
          >
              ...
              {/* Text Content */}
              <p className="text-white text-base leading-relaxed mt-2 font-medium font-sans">
                  "{config.speechText}"
              </p>
